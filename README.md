...
a TidyTuesday dataset as a course activity. Each student will inquire
the selected dataset, and with {tidyverse} tools will aim to solve its
question.
